...
import SegmentsTable from 'src/components/experiments/single-view/overview/SegmentsTable'
import VariationsTable from 'src/components/experiments/single-view/overview/VariationsTable'
