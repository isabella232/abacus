...
import SegmentsTable from 'src/components/experiment/single-view/overview/SegmentsTable'
import VariationsTable from 'src/components/experiment/single-view/overview/VariationsTable'
